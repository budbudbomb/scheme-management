    ...
    <div className="space-y-2.5">
      ...
      {activeDistrict && (
        <div className="space-y-3.5 animate-in fade-in duration-200">
              ...
              <div className="space-y-1">
                {role === 'pc' && (
                  <button
                    ...
                    className="flex items-center gap-2 text-xs text-indigo-600 hover:text-indigo-800 font-semibold transition-colors cursor-pointer mb-2"
                  >
                    <span className="flex items-center justify-center w-7 h-7 rounded-full border border-indigo-200 bg-white hover:bg-indigo-50 text-indigo-600 shadow-2xs shrink-0">
          ...
          {/* ══════════════════════════════════════════════════════════════════
              INTERACTIVE CONTROL BAR: FILTERS + SEARCH
             ══════════════════════════════════════════════════════════════════ */}
            ...
            <div className="flex items-center gap-1 overflow-x-auto pb-1 sm:pb-0 scroll-hide">
              {(['all', 'completed', 'in_progress', 'pending', 'overdue'] as StatusFilter[]).map((status) => (
                <button
                  ...
                  className={cn(
                    'px-2.5 py-1.5 rounded-lg text-[11px] font-semibold capitalize whitespace-nowrap transition-colors cursor-pointer',
                    statusFilter === status
