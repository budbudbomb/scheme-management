      ...
      <div className="max-w-md w-full bg-white rounded-2xl shadow-sm border border-slate-200 p-8 text-center space-y-6">
        ...
        <div>
          ...
          <p className="mt-2 text-sm text-slate-500">
            Hi {user?.name}, your registration as an Intern is complete, but your account is pending block allocation.
          </p>
          <p className="mt-4 text-sm text-slate-600 font-medium">
            The state admin team will review your application and allocate your block soon.
          </p>
        </div>
