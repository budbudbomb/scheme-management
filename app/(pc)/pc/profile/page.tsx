...
export default function PcProfilePage() {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6 pb-8">
      ...
      {/* Header Profile Card */}
      <div className="card p-6 bg-gradient-to-r from-indigo-900/5 via-slate-50 to-sky-900/5 border-slate-200 text-center sm:text-left">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 items-center">
                <div className="flex flex-col items-center sm:items-start">
                  <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2.5">
                    ...
                    <span className="badge bg-indigo-100 text-indigo-700 border-indigo-200">Project Coordinator</span>
                  </div>
        ...
        <div className="lg:col-span-1">
          <div className="card p-6">
            ...
            <DetailList
              columns={1}
              rows={[
                { label: 'Program', value: 'CMYP — Project Coordinator' },
