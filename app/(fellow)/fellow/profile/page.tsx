...
import { UserCircle, PencilSimple, Check, X, ArrowCircleUpRight } from '@phosphor-icons/react';
      ...
      <div className="sm:hidden card p-4 bg-rose-50/70 border border-rose-200 shadow-2xs">
        <div className="flex items-center justify-between gap-3">
          <div>
            ...
            <div className="text-2xs text-slate-500">Apply to conclude your fellowship & get certificate</div>
          </div>
          <Link
            href="/fellow/exit"
