      ...
      {activeTab === 'apply' && (
        <div className="space-y-3.5">
          <div className="flex items-center justify-between px-1">
            ...
            <span className="text-xs text-slate-500 font-medium">{fellowLeaves.length} record(s)</span>
          </div>
              ...
              {fellowLeaves.map(app => {
                ...
                return (
                  <div key={app.id} className="card p-4 sm:p-5 hover:border-slate-300 transition-all space-y-3 shadow-2xs">
                    ...
                    {/* Action Buttons: View details always; Upload Document ONLY if attached */}
