    ...
    <div className="space-y-6">
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-0.5">Apply for leave and track approvals</p>
        </div>
        <button
          id="apply-leave-btn"
        ...
        <div className="card p-6">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div>
              ...
              <textarea {...register('reason')} rows={3} placeholder="Describe the reason for your leave…" className={cn(inputCls(!!errors.reason), 'resize-none')} />
      ...
      {loading ? <SkeletonCard /> : error ? (
        ...
        <div className="card"><EmptyState icon={ClipboardText} title="No leave applications" description="Your leave applications will appear here once you apply." /></div>
      ) : (
            ...
            <div key={app.id} className="card p-4">
              <div className="flex items-start justify-between gap-3">
                <div>
                  ...
                  <div className="text-xs text-slate-500 mt-0.5 truncate-2">{app.reason}</div>
                </div>
