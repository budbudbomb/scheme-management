...
export const MOCK_LEAVE_APPLICATIONS: LeaveApplication[] = [
  ...
  {
    id: 'leave-02', applicant: { id: 'u-intern-01', name: 'Priya Patel', role: 'intern' },
    leaveType: 'casual', startDate: '2026-08-20', endDate: '2026-08-21',
    ...
    approverComment: 'Approved. Ensure fieldwork survey reports are synced upon return.',
  },
  {
...
export const MOCK_EXIT_REQUESTS: ExitRequest[] = [
  {
    ...
    reason: 'Tenure completed, preparing for civil service examinations',
  ...
  {
    id: 'exit-02',
    applicant: { id: 'u-intern-03', name: 'Sunita Meena', role: 'intern' },
    applicantRole: 'intern',
    reason: 'Completed 6-month internship deliverables successfully',
    status: 'pending_pm_review',
    appliedAt: '2026-09-04T11:00:00Z',
    incompleteTasks: 0,
    division: 'Bhopal Division',
    district: 'Sehore',
    block: 'Ashta',
  ...
  {
    id: 'exit-03',
    applicant: { id: 'u-fellow-09', name: 'Pankaj Sharma', role: 'fellow' },
    applicantRole: 'fellow',
    reason: 'Fellowship contract tenure concluded',
    status: 'pending_pc_review',
    appliedAt: '2026-09-05T09:15:00Z',
    incompleteTasks: 1,
  ...
  {
    id: 'exit-04',
    applicant: { id: 'u-fellow-04', name: 'Priya Sharma', role: 'fellow' },
    applicantRole: 'fellow',
    reason: 'Completed fellowship tenure and all district assessments',
    status: 'pending_pm_review',
    appliedAt: '2026-09-03T08:45:00Z',
    incompleteTasks: 0,
    division: 'Indore Division',
    district: 'Dhar',
    block: 'Dhar Rural',
    reviewedByPc: { id: 'usr-pc-01', name: 'Anjali Verma', role: 'pc' },
    pcComment: 'Excellent dedication across Indore division. All survey milestones met. Strongly recommend for certificate.',
    pcReviewedAt: '2026-09-06T14:20:00Z',
    certificateEligible: true,
    certificateEligibilityMarkedBy: { id: 'usr-pc-01', name: 'Anjali Verma', role: 'pc' },
    certificateEligibilityNote: 'Completed 100% assigned tasks and 52 village surveys.',
    performanceAudit: {
      tasksTotal: 20,
      tasksCompleted: 20,
      tasksPending: 0,
  ...
  {
    id: 'exit-05',
    applicant: { id: 'usr-pc-02', name: 'Kavita Sen', role: 'pc' },
    applicantRole: 'pc',
    reason: 'Completed coordination tenure for Ujjain division',
    status: 'pending_pm_review',
    appliedAt: '2026-09-06T16:00:00Z',
    incompleteTasks: 0,
  ...
  },
  {
    ...
    applicantRole: 'fellow',
    reason: 'Completed full 1-year program duration',
    status: 'approved',
    ...
    block: 'Sihora',
    reviewedByPc: { id: 'usr-pc-01', name: 'Anjali Verma', role: 'pc' },
    pcComment: 'All field deliverables verified.',
    pcReviewedAt: '2026-08-18T11:00:00Z',
    certificateEligible: true,
    certificateEligibilityMarkedBy: { id: 'usr-pc-01', name: 'Anjali Verma', role: 'pc' },
    approvedBy: { id: 'pm-hr-01', name: 'Sunil Sharma', role: 'pm' },
    approverComment: 'Tenure completed with exceptional remarks. Certificate of Completion awarded.',
    approvedAt: '2026-08-20T15:00:00Z',
    certificateIssued: true,
    certificateIssuedAt: '2026-08-20T15:00:00Z',
    certificateUrl: '/completion-certificate.pdf',
    performanceAudit: {
      tasksTotal: 18,
      tasksCompleted: 18,
      tasksPending: 0,
